...
**Version**: 0.10.0 | **Time to first recall: ~3 minutes**
...
SQLite FTS5 matches items where **all** query terms appear in a single item. This is why short, precise queries (2-3 identifiers) work best. Natural language sentences over-constrain and often return 0 results. Since v0.10.0, stop words are stripped automatically to mitigate this.
