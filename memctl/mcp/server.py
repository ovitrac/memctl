...
_MCP_INSTRUCTIONS = (
    "Persistent structured memory for LLM orchestration (18 tools).\n"
    "\n"
    ...
    "COMPARE: Use memory_diff to compare two items or item vs revision.\n"
...
def create_server(args=None):
    ...
    # Register all 18 tools with middleware
